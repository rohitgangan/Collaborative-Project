...
public class UserController {
	...
	public ResponseEntity<NewUser> getUserById(@PathVariable("userId") Integer userId){
	...
	public ResponseEntity<List<NewUser>> listNewUser() {
		List<NewUser> list = userService.listNewUser();
		return new ResponseEntity<List<NewUser>>(list, HttpStatus.OK);
	}
	
	@RequestMapping(value="newUser/{userId}", method=RequestMethod.PUT)
