...
/*app.service("ChatService", ['$q','$timeout',function($q, $timeout) {*/
    ...
    service.SOCKET_URL = "http://localhost:8082/connectit/chat";
    service.CHAT_TOPIC = "/topic/message";
    service.CHAT_PRIVATE = "/user/exchange/amq.direct/chat.message";
    ...
    var getMessage = function(data) {
      ...
      var startListener = function() {
        ...
        socket.stomp.subscribe(service.CHAT_PRIVATE, function(data) {
            listener.notify(getMessage(data.body));
          });
      };
